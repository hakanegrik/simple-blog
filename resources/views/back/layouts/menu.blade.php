...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item"@if(Request::segment(2)=="makaleler" and !Request::segment(3)) active @endif href="{{route('admin.makaleler.index')}}">Makaleler</a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{route('admin.messages')}}">
            <span>Mesajlar</span>
            </a>
        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('homepage')}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-globe fa-sm text-white-50"></i> Site</a>
                </div>
